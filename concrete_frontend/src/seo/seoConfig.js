...
export const PAGES = {
  ...
  concreteLanding: {
    ...
    description: {
      ...
      en: 'Ready-mix concrete delivery in Baku and Absheron. Grades from M100 to M600 including high-strength concrete, pumping service and professional support.',
      ru: 'Производство и доставка товарного бетона по Баку и Абшерону. Марки от М100 до М600, включая высокопрочный бетон, услуги бетононасоса и профессиональная поддержка.',
    },
    crumb: null,
  },
  products: {
    path: '/products',
    title: {
      az: 'Beton Markaları M100–M600 | NOVXANI BETON',
      en: 'Concrete Grades M100–M600 | NOVXANI BETON',
      ru: 'Марки бетона M100–M600 | NOVXANI BETON',
    },
    description: {
      az: 'M100-dən M600-ə qədər bütün beton markaları — o cümlədən M500, M550 və M600 yüksək möhkəmlikli betonlar. Möhkəmlik sinfi, istifadə sahəsi, GOST 26633 üzrə istehsal və 28 günlük möhkəmlik sınağı.',
      en: 'All concrete grades from M100 to M600 — including the high-strength M500, M550 and M600. Strength class, applications, GOST 26633 production and 28-day strength testing.',
      ru: 'Все марки бетона от M100 до M600 — включая высокопрочные M500, M550 и M600. Класс прочности, области применения, производство по ГОСТ 26633 и 28-дневные испытания на прочность.',
    },
